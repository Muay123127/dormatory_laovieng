...
function autoID(){
    ...
    $sql = "SELECT Max(empno) AS empno FROM emp";
    $result = mysqli_query($link, $sql);
    $row = mysqli_fetch_assoc($result);
    if(empty($row['empno'])) {
        $empno = "EMP001";
    }else {
        $id = substr($row['empno'], 3, strlen($row['empno']));
        $id++;
        $empno = "EMP" . sprintf("%03d", $id);
    }
    return $empno;
}
//ເອີ້ນໃຊ້ autoID   
...
if (isset($_POST['btnAdd'])) {
    ...
    $sql = "INSERT INTO emp VALUES('". autoID()."', '$empname', '$gender', '$date_birth', '$address', "
    ...
    if ($result) {
        ...
        $empname = $gender = $date_birth = $address = $file_image = $department = $salary = $incentive = $language = null;

        //ເອີ້ນໃຊ້ເພື່ອຫາລະຫັດໃໝ່
        autoID();
    } else {
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="empno" placeholder="ກະລຸນາປ້ອນລະຫັດພະນັກງານ" name="empno" value="" placeholder="ລະຫັດໃສ່ອັດຕະໂນມັດ" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <!--ຊື່ພະນັກງານ-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div style="text-align: center">
                                                <img id='img-upload' />
                                                <div id="temp_img">
                                                    <img src="images/avatar_img.png" alt="avatar_img.png" width="150px" height="180px" />
                                                </div>
                                                <!--ເລືອກຮູບພາບ-->
                                                <br>
                                                <div class="input-group">
                                                    <span class="input-group-btn">
                                                        <span class="btn btn-info btn-file">
                                                            ເລືອກຮູບ<input type="file" id="imgInp" name="file_image" accept="image/*" required>
                                                        </span>
                                                    </span>
